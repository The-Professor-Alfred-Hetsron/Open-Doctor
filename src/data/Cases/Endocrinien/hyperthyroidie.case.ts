const HYPERTHYROIDIE = {
  desease: "Hyperthyroïdie",
  ...
  anamèse: {
    ...
    symptoms: {
      main: "Perte de poids rapide",
      associated: ["Diarrhée", "Nausée"],
