const INFARCTUS_MYOCARDE = {
  desease: "Infarctus aigu du myocarde",
  ...
  anamèse: {
    ...
    symptoms: {
      main: "Sensation de serrement dans la poitrine",
      associated: ["Vertiges", "Fatigue", "Vomissements"],
      onset_date: "2022-01-10",
      aggravating_factors: [" "],
      concurrent_symptoms: ["Indigestion", "Palpitation"],
    },
    lifestyle: {
      diet: "équilibré",
  ...
  physical_examination: {
    ...
    neck: "Sensation de serrement dans le cou",
    chest: {
      inspection: "Aucune déformation",
      palpation: "Aucune masse",
      auscultation: "Respiration anormale",
    },
    abdomen: {
...
export default INFARCTUS_MYOCARDE;
