const HYPERTENSION_ESSENTIELLE = {
  desease: "Hypertension essentielle",
  biologic_system: "Système Cardiovasculaire",
  anamèse: {
    patient: {
      last_name: "EOJLD",
      first_name: "Elov",
    ...
    medical_history: {
      past_illnesses: ["Infection au staphylocoque"],
      surgeries: ["Augmentation mamaire"],
      family_history: {
        parents: [],
        siblings: [],
      },
    ...
    symptoms: {
      ...
      aggravating_factors: ["Coma"],
      concurrent_symptoms: ["Pouls rapide"],
    },
    lifestyle: {
      diet: "Equilibré",
      physical_activity: "Course à pied",
      tobacco_use: "Non-fumeur",
      alcohol_consumption: "Ne consomme pas d'alcool",
      sleep: {
        hours: 7,
        habits: "Irrégulier",
      },
    ...
    events_changes: {
      stressful_events: ["Examens de fin d'année"],
      change_in_lifestyle: " ",
    },
    gynecological: {
  ...
  physical_examination: {
    ...
    neck: "Gonflement des ganglions lymphatiques",
    chest: {
...
export default HYPERTENSION_ESSENTIELLE;
