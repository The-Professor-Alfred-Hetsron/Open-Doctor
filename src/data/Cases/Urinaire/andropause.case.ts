const ANSDROPAUSE = {
  ...
  anamèse: {
    ...
    symptoms: {
      main: "Fragilité osseuse",
      associated: ["Sudation importante", "Troubles du sommeil"],
      onset_date: "2022-01-10",
      aggravating_factors: ["Nervosité accrue"],
      concurrent_symptoms: ["Bouffées de chaleur"],
    },
    lifestyle: {
      diet: "équilibré",
