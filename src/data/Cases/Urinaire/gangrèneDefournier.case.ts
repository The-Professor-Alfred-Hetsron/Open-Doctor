const GANFRENE_DE_FOURNIER = {
  desease: "Gangrène de Fournier",
  biologic_system: "Système Urinaire",
  anamèse: {
    patient: {
      last_name: "EOJLD",
      first_name: "Elov",
    ...
    symptoms: {
      main: "Inflammation et oedème au niveau du scrotum",
      associated: ["Fièvre élevée", "Fatigue"],
      onset_date: "2022-01-10",
      aggravating_factors: [
        "Douleurs intenses dans la zone périnéale",
        "Nécroses tissulaires",
      ],
      concurrent_symptoms: ["Ulcères"],
    },
    lifestyle: {
      diet: "équilibré",
      physical_activity: "Tenis de table ",
  ...
  physical_examination: {
    ...
    skin: "Nécroses tissulaires",
    head: {
      eyes: "Rien à signaler ",
      ears: "Aspect normale",
      nose: "Aspect normale",
...
export default GANFRENE_DE_FOURNIER;
