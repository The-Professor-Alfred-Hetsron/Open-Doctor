const AVC = {
  ...
  anamèse: {
    ...
    symptoms: {
      main: "Faiblesse soudaine d'un côté du corps",
      associated: ["Troubles de la parole", "Perte de vision"],
  ...
  physical_examination: {
    ...
    neurological:
      "Fonction motrice altérée du côté gauche, déficits sensoriels du côté droit",
  },
  laboratory_tests: {
    blood_tests: {
